...
class InterfazApiBodega:
    ...
    def obtenerActualizacionesVinos(self, bodegas):
        ...
        listaVinosActualizados = [
            Vino("Santa Julia", "Santa Julia Malbec", 2020, "etiqueta_anta_julia_malbec.jpg", 8500, None, None, "Frutado con notas de ciruela y moras."),
            ...
            Vino("Santa Julia", "Santa Julia Cabernet Sauvignon", 2017, "etiqueta_santa_julia_cabernet.jpg", 9500, None, None, "Aromas a pimiento verde y grosella negra." ),
            Vino("La Azul", "La Azul Malbec", 2016, "etiqueta_la_azul_malbec.jpg", 7500, None, None, "Sabores intensos de ciruela y especias."),
            Vino("Los Toneles", "Los Toneles Reserva", 2015, "etiqueta_los_toneles_reserva.jpg", 6500, None, None, "Cuerpo robusto con sabores de roble y frutas maduras."),
            Vino("Los Toneles", "Tonel 46", 2018, "etiqueta_los_toneles_46.jpg", 8750, None, None, "Cuerpo robusto con sabores de roble y frutas maduras."),
        ]
